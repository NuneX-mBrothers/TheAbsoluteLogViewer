...
window.I18N.zh = {
  ...
  "feat.text.t": "不只是 .log——任何文本日志",
  "feat.text.d": "Linux 和 Unix 日志形式各异：syslog、messages、轮转后的 auth.log.1，甚至没有扩展名的文件。设置文件匹配模式，即可跟踪所有匹配的文本文件——二进制文件会被自动排除。",
  "feat.tail.t": "日志实时跟踪",
  "feat.tail.d": "实时跟踪日志文件——新行即时滚入。向上滚动暂停，回到底部继续。",
  "feat.tabs.t": "独立标签页",
  ...
  "how.2.t": "指向你的日志",
  "how.2.d": "添加文件夹或单个文件。按你的文件匹配模式找出日志，自动排除二进制文件，并持续监视。",
  "how.3.t": "实时查看",
  ...
  "install.smartscreen": "Standalone 与 Portable 下载均已数字签名——Windows 会显示发布者姓名。由于签名较新，浏览器或 Windows 可能仍会请你确认：点击“更多信息”→“仍要运行”。如需核对，每个版本都会公布 SHA-256。",
  ...
  "faq.q2": "打开时 Windows 要求确认，为什么？",
  "faq.a2": '签名较新，Windows 需要一段时间才会认识新的发布者——这与文件本身无关。点击“更多信息”→“仍要运行”。ClickOnce 安装保留自己的签名，仍可能显示“未知发布者”。每个版本都会公布可核对的 <code>SHA-256</code>。',
  "faq.q3": "我该选哪个版本？",
