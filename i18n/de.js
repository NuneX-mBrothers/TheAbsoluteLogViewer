...
window.I18N.de = {
  ...
  "feat.text.t": "Nicht nur .log — jedes Text-Log",
  "feat.text.d": "Linux- und Unix-Logs gibt es in jeder Form: syslog, messages, ein rotiertes auth.log.1, Dateien ganz ohne Endung. Gib Dateimuster an, und es verfolgt jede passende Textdatei — Binärdateien werden automatisch übersprungen.",
  "feat.tail.t": "Echtzeit-Tail von Logs",
  ...
  "how.2.d": "Ordner oder einzelne Dateien hinzufügen. Logs, die zu deinen Dateimustern passen, werden erkannt, Binärdateien übersprungen — und alles wird überwacht.",
  ...
  "install.smartscreen": "Die Downloads Standalone und Portable sind digital signiert — Windows zeigt den Namen des Herausgebers. Da die Signatur neu ist, fragen Browser oder Windows unter Umständen noch nach: Klicken Sie auf Weitere Informationen → Trotzdem ausführen. Auf Wunsch prüfen Sie den SHA-256, der mit jeder Version veröffentlicht wird.",
  ...
  "faq.q2": "Windows fragt beim Öffnen nach. Warum?",
  "faq.a2": 'Die Signatur ist neu, und Windows braucht eine Weile, um einen neuen Herausgeber zu erkennen — es liegt nicht an der Datei. Klicken Sie auf Weitere Informationen → Trotzdem ausführen. Die ClickOnce-Installation behält ihre eigene Signatur und kann weiterhin „Unbekannter Herausgeber“ anzeigen. Jede Version veröffentlicht einen prüfbaren <code>SHA-256</code>.',
