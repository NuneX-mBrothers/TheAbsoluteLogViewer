...
window.I18N.fr = {
  ...
  "feat.text.t": "Pas seulement .log — tout log texte",
  "feat.text.d": "Les logs Linux et Unix prennent toutes les formes : syslog, messages, un auth.log.1 issu d’une rotation, des fichiers sans extension. Donnez-lui des motifs de fichiers et il suit tous les fichiers texte qui correspondent — les binaires sont écartés automatiquement.",
  "feat.tail.t": "Tail de logs en temps réel",
  "feat.tail.d": "Suit les fichiers de log en direct — les nouvelles lignes arrivent à l’instant. Défilez vers le haut pour mettre en pause, revenez en bas pour reprendre.",
  ...
  "feat.csv.t": "Tail de .csv en colonnes",
  "feat.csv.d": "Aussi .csv/.tsv, mais en tableau — l’en-tête du fichier devient les titres des colonnes et les nouvelles lignes apparaissent en direct. Virgule, point-virgule ou tabulation, détectés automatiquement.",
  ...
  "how.2.d": "Ajoutez des dossiers ou des fichiers isolés. Il retient les logs qui correspondent à vos motifs, écarte les binaires et les surveille.",
  ...
  "install.smartscreen": "Les téléchargements Standalone et Portable sont signés numériquement — Windows affiche le nom de l’éditeur. La signature est récente : votre navigateur ou Windows peuvent encore demander confirmation. Cliquez sur Informations complémentaires → Exécuter quand même. Si vous le souhaitez, vérifiez le SHA-256, publié à chaque version.",
  ...
  "faq.q2": "Windows demande confirmation à l’ouverture. Pourquoi ?",
  "faq.a2": 'La signature est récente, et Windows met un certain temps à reconnaître un nouvel éditeur — ce n’est pas un problème du fichier. Cliquez sur Informations complémentaires → Exécuter quand même. L’installation ClickOnce conserve sa propre signature et peut encore afficher « Éditeur inconnu ». Chaque version publie un <code>SHA-256</code> vérifiable.',
