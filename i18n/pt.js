...
window.I18N.pt = {
  ...
  "hero.sub": 'Um visualizador de logs para Windows rápido e moderno, em .NET&nbsp;10 / WPF. Tail ao vivo, abas independentes, regras de highlight com regex, comparação em painel duplo e preview de contexto — <b>em 16 línguas</b>.',
  ...
  "feat.csv.d": "Também .csv/.tsv, mas em tabela — o cabeçalho do ficheiro vira os títulos das colunas e as novas linhas aparecem ao vivo. Vírgula, ponto-e-vírgula ou tab, detetados automaticamente.",
  ...
  "langs.title": "16 línguas, trocadas ao vivo.",
  ...
  "install.smartscreen": "As descargas Standalone e Portable estão assinadas digitalmente — o Windows mostra o nome do editor. Como a assinatura é recente, o browser ou o Windows ainda podem pedir confirmação: clica em Mais informações → Executar mesmo assim. Se quiseres, confirma o SHA-256, publicado em cada versão.",
  ...
  "faq.q2": "O Windows pede confirmação ao abrir. Porquê?",
  "faq.a2": 'A assinatura é recente, e o Windows leva algum tempo a reconhecer um editor novo — não é um problema com o ficheiro. Clica em Mais informações → Executar mesmo assim. A instalação por ClickOnce mantém a assinatura própria e pode ainda mostrar “Editor desconhecido”. Cada versão publica um <code>SHA-256</code> que podes verificar.',
