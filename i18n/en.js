...
window.I18N.en = {
  ...
  "feat.text.t": "Not just .log — any text log",
  "feat.text.d": "Linux and Unix logs come in every shape: syslog, messages, a rotated auth.log.1, files with no extension at all. Give it file patterns and it follows every text file that matches — binary files are skipped automatically.",
  "feat.tail.t": "Real-time log tailing",
  "feat.tail.d": "Follow log files live — new lines stream in instantly. Scroll up to pause, hit the bottom to resume.",
  ...
  "feat.csv.t": "Tail .csv in columns",
  "feat.csv.d": "Also .csv/.tsv, but as a table — the file's header becomes the column titles and new rows appear live. Comma, semicolon or tab, auto-detected.",
  ...
  "how.2.d": "Add folders or single files. It picks up the logs that match your file patterns, skips binaries and watches them.",
  ...
  "ed.sa.tag": "Smallest",
  "ed.sa.h": "Standalone",
  "ed.sa.lede": "A single ~2.5 MB .exe. Needs the .NET 10 Desktop Runtime installed.",
  ...
  "install.smartscreen": "The Standalone and Portable downloads are digitally signed — Windows shows the publisher's name. The signature is recent, so your browser or Windows may still ask you to confirm: click More info → Run anyway. If you like, check the SHA-256 published with every release.",
  ...
  "faq.q2": "Windows asks me to confirm when opening. Why?",
  "faq.a2": 'The signature is recent, and Windows takes a while to recognise a new publisher — it is not a problem with the file. Click More info → Run anyway. The ClickOnce install keeps its own signature and may still show “Unknown publisher”. Every release publishes a <code>SHA-256</code> you can verify.',
